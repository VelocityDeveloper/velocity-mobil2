...
if( ! function_exists( 'justg_child_enqueue_parent_style') ) {
	function justg_child_enqueue_parent_style() {
        ...
        wp_enqueue_style( 'slick-style', 'https://cdnjs.cloudflare.com/ajax/libs/PrintArea/2.4.1/PrintArea.min.css', $css_version);
        ...
        wp_enqueue_script( 'printArea-scripts', 'https://cdnjs.cloudflare.com/ajax/libs/PrintArea/2.4.1/jquery.PrintArea.min.js', array(), $js_version, true );
        ...
        wp_enqueue_script( 'chained-scripts', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-chained/1.0.1/jquery.chained.min.js', array(), $js_version, true );
